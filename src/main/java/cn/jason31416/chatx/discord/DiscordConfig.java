...
public class DiscordConfig {
    ...
    public static DiscordConfig load(@Nonnull MapTree tree) {
        ...
        Formats formats = new Formats(
                ...
                formatTree.getString("join", "➡️ **{name}** joined the network on **{server}**"),
                formatTree.getString("leave", "⬅️ **{name}** left the network from **{server}**"),
                formatTree.getString("server-join", "➡️ **{name}** joined {server}"),
                formatTree.getString("server-leave", "⬅️ **{name}** left {server}"),
                formatTree.getString("switch", "↔️ **{name}** moved from {previous-server} to {server}"),
